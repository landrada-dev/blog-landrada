                    ...
                    <form method="post" enctype="multipart/form-data" action="{{ route('article.update', $article) }}"
                        ...
                        <div class="card ">
                            <div class="card-header card-header-rose card-header-icon">
                                ...
                                <h4 class="card-title">{{ __('Editar Articulo') }}</h4>
                            </div>
                            <div class="card-body ">
                                <div class="row">
                                ...
                                <div class="row">
                                    <label class="col-sm-2 col-form-label">{{ __('Extracto') }}</label>
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('excerpt') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('excerpt') ? ' is-invalid' : '' }}"
                                                name="excerpt" id="input-excerpt" type="text" placeholder="{{ __('Extracto') }}"
